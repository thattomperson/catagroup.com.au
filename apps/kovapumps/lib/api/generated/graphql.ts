...
/** A type of product that we can sell */
...
export type Product = Node & {
  ...
  /** The unique identifier */
  id: Scalars['ID'];
  /** First image will be featured on the product page */
  images: Array<Asset>;
  name: Scalars['String'];
  /** The time the document was published. Null on documents in draft stage. */
  publishedAt?: Maybe<Scalars['DateTime']>;
...
export type HomeCategoryListQuery = { __typename?: 'Query', categories: Array<{ __typename?: 'Category', name: string, slug: string, description?: string | null | undefined, image: { __typename?: 'Asset', height?: number | null | undefined, width?: number | null | undefined, url: string } }> };

export const HeaderCategoryFieldsFragmentDoc = gql`
...
export const CategoryPageItemsDocument = gql`
  ...
  categories {
    ...
    `;
export const CategoryPageItemDocument = gql`
...
export const HomeCategoryListDocument = gql`
